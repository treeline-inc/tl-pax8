...
class TestFindOrders200Response(unittest.TestCase):
    """FindOrders200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FindOrders200Response:
        """Test FindOrders200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FindOrders200Response`
        """
        model = FindOrders200Response()
        if include_optional:
            return FindOrders200Response(
                content = [
                    tl_pax8.models.order.Order(
                        id = '', 
                        company_id = '', 
    ...
    def testFindOrders200Response(self):
        """Test FindOrders200Response"""
