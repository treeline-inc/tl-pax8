...
class FindUsageLines200Response(BaseModel):
    """
    FindUsageLines200Response
    """ # noqa: E501
    content: Optional[List[UsageLine]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [UsageLine.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
