...
class Company(BaseModel):
    ...
    address: Address
    phone: StrictStr = Field(description="The primary phone number of the company")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "address", "phone", "website", "externalId", "billOnBehalfOfEnabled", "selfServiceAllowed", "orderApprovalRequired", "status", "updatedDate"]
