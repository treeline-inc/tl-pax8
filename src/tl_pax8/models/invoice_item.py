...
class InvoiceItem(BaseModel):
    ...
    sales_tax: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The sales tax amount for this invoice item", alias="salesTax")
    subscription_id: Optional[StrictStr] = Field(default=None, description="The identifier of the associated subscription. This field will contain the subscription identifier for all product types, allowing partners to link this invoice line item to the relevant subscription details. Products that do not have a subscription id (i.e., BitTitan migration) will return a null value.", alias="subscriptionId")
    __properties: ClassVar[List[str]] = ["id", "purchaseOrderNumber", "type", "companyId", "externalId", "companyName", "startPeriod", "endPeriod", "quantity", "unitOfMeasure", "term", "sku", "description", "details", "rateType", "chargeType", "price", "subTotal", "cost", "costTotal", "offeredBy", "billedByPax8", "total", "productId", "productName", "billingFee", "billingFeeRate", "amountDue", "currencyCode", "salesTax", "subscriptionId"]
