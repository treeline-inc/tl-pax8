...
class FindOrders200Response(BaseModel):
    """
    FindOrders200Response
    """ # noqa: E501
    content: Optional[List[Order]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [Order.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
