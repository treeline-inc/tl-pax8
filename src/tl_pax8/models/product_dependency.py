...
class ProductDependency(BaseModel):
    ...
    ProductDependency
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the product constraint")
    products: Optional[List[Product]] = Field(default=None, description="A list of products that satisfy the constraint")
    __properties: ClassVar[List[str]] = ["name", "products"]
