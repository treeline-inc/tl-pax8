...
class CreateOrder(BaseModel):
    ...
    line_items: List[CreateLineItem] = Field(alias="lineItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lineItems": [CreateLineItem.from_dict(_item) for _item in obj["lineItems"]] if obj.get("lineItems") is not None else None
        })
        return _obj
