...
class InvoicesApi:
    ...
    @validate_call
    def find_partner_draft_invoice_items(
        self,
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The page number to request in the draft invoice items list")] = None,
        size: Annotated[Optional[Union[Annotated[float, Field(le=200, strict=True, ge=1)], Annotated[int, Field(le=200, strict=True, ge=1)]]], Field(description="Returns _this_ number of draft invoice items per page")] = None,
        month_offset: Annotated[Optional[StrictInt], Field(description="Number of months from current to return draft items for. 0 = current month, 1 = next month. Only values 0 and 1 are currently supported. If omitted, defaults to 1 (next month). ")] = None,
        company_id: Annotated[Optional[StrictStr], Field(description="Filter draft items to a specific company. ")] = None,
        ...
        :param page: The page number to request in the draft invoice items list
        :type page: float
        :param size: Returns _this_ number of draft invoice items per page
        :type size: float
        :param month_offset: Number of months from current to return draft items for. 0 = current month, 1 = next month. Only values 0 and 1 are currently supported. If omitted, defaults to 1 (next month). 
        :type month_offset: int
        :param company_id: Filter draft items to a specific company. 
        :type company_id: str
        ...
        _param = self._find_partner_draft_invoice_items_serialize(
            page=page,
            size=size,
    ...
    @validate_call
    def find_partner_draft_invoice_items_with_http_info(
        self,
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The page number to request in the draft invoice items list")] = None,
        size: Annotated[Optional[Union[Annotated[float, Field(le=200, strict=True, ge=1)], Annotated[int, Field(le=200, strict=True, ge=1)]]], Field(description="Returns _this_ number of draft invoice items per page")] = None,
        month_offset: Annotated[Optional[StrictInt], Field(description="Number of months from current to return draft items for. 0 = current month, 1 = next month. Only values 0 and 1 are currently supported. If omitted, defaults to 1 (next month). ")] = None,
    ...
    @validate_call
    def find_partner_draft_invoice_items_without_preload_content(
        self,
        page: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The page number to request in the draft invoice items list")] = None,
        size: Annotated[Optional[Union[Annotated[float, Field(le=200, strict=True, ge=1)], Annotated[int, Field(le=200, strict=True, ge=1)]]], Field(description="Returns _this_ number of draft invoice items per page")] = None,
        month_offset: Annotated[Optional[StrictInt], Field(description="Number of months from current to return draft items for. 0 = current month, 1 = next month. Only values 0 and 1 are currently supported. If omitted, defaults to 1 (next month). ")] = None,
    ...
    def _find_partner_draft_invoice_items_serialize(
        self,
        page,
        size,
        month_offset,
        ...
        if month_offset is not None:
            ...
            _query_params.append(('monthOffset', month_offset))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/invoices/draftItems',
